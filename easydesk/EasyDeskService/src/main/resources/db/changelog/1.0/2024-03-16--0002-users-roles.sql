...
VALUES ('ADMINISTRATOR', 'READ_TICKETS'),
       ('ADMINISTRATOR', 'READ_TICKETS_OWNER'),
       ('ADMINISTRATOR', 'CREATE_TICKETS'),
       ('ADMINISTRATOR', 'MODIFY_TICKETS'),
       ('ADMINISTRATOR', 'MODIFY_TICKETS_OWNER'),
       ('ADMINISTRATOR', 'DELETE_TICKETS'),
       ('ADMINISTRATOR', 'DELETE_TICKETS_OWNER'),
       ('ADMINISTRATOR', 'READ_COMMENTS'),
       ('ADMINISTRATOR', 'CREATE_COMMENTS'),
       ('ADMINISTRATOR', 'MODIFY_COMMENTS'),
       ('ADMINISTRATOR', 'DELETE_COMMENTS'),
       ('ADMINISTRATOR', 'READ_ATTACHMENTS'),
       ('ADMINISTRATOR', 'CREATE_ATTACHMENTS'),
       ('ADMINISTRATOR', 'MODIFY_ATTACHMENTS'),
       ('ADMINISTRATOR', 'DELETE_ATTACHMENTS'),
       ('ADMINISTRATOR', 'READ_REPORTS'),
       ('DEVELOPER', 'READ_TICKETS'),
       ('DEVELOPER', 'MODIFY_TICKETS'),
       ('DEVELOPER', 'READ_REPORTS'),
       ('CUSTOMER', 'READ_TICKETS_OWNER'),
       ('CUSTOMER', 'CREATE_TICKETS'),
       ('CUSTOMER', 'MODIFY_TICKETS_OWNER'),
       ('CUSTOMER', 'DELETE_TICKETS_OWNER'),
       ('CUSTOMER', 'READ_REPORTS')
;
