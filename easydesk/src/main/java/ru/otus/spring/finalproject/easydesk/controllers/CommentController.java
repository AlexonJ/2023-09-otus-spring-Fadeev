...
public interface CommentController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Successfully created new comment",
    ...
    ResponseEntity<CommentDto> createComment(
            ...
            @PathVariable(name = "ticketCode") @Parameter(name = "ticketCode", description = "Ticket code to associate with the new comment") String ticketCode);
    ...
    ResponseEntity<CommentDto> updateComment(
            @RequestParam @Parameter(name = "commentContent", description = "New comment text") String commentText,
            @PathVariable(name = "commentId") @Parameter(name = "commentId", description = "Comment ID to modification") Long commentId);
