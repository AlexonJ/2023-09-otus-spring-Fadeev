...
public interface TicketController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved the list of tickets",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = TicketSearchResponse.class))),
    ...
    @GetMapping
    ResponseEntity<TicketSearchResponse> getTicketList(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved new ticket",
    ...
    ResponseEntity<TicketDto> createTicket(
            @RequestBody @Parameter(name = "request", description = "Ticket modification request")
